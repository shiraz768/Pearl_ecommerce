...
<section class="section-slide">
	<div class="wrap-slick1">
		<div class="slick1">
			<div class="item-slick1" style="background-image: url(images/carousalimg1.png);">
			...
			<div class="item-slick1" style="background-image: url(images/carousalimg2.jpeg);">
				<div class="container h-full">
					<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
	...
	<div class="container">
		...
		<div class="flex-w flex-sb-m p-b-52">
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				...
				<!-- Button Fetch According to the categories + filter in database query start here -->
				<?php
$query = $pdo ->query("select * from category");
$row  = $query->fetchAll(PDO::FETCH_ASSOC);
foreach($row as $cat){
...
?>
<!-- Button Fetch According to the categories + filter in database query ends here -->
		...
		<!-- Product Filter matching according to the specific approched category made on button query starts here-->
		<?php
				$query= $pdo->query("select * from product");
				$row  = $query->fetchAll(PDO::FETCH_ASSOC);
				foreach($row as $proall){
					?>
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $proall['cat_type_id']?>">
					<!-- Block2 -->
					<div class="block2">
...
?>
		...
		<!-- Product Filter matching according to the specific approched category made on button query ends here-->
